...
if (typeof gemius_hcconn == "undefined") {
	gemius_hcconn = {
		...
		hc : (typeof gemius_hitcollector === 'string')?gemius_hitcollector:(typeof pp_gemius_hitcollector === 'string')?pp_gemius_hitcollector:'gabe.hit.gemius.pl',
...
if (typeof gemius_hcref == "undefined" && typeof gemius_hcconn != "undefined") {
	gemius_hcref = true;
	gemius_hcconn.add_event(window,'message',function(e) {
		if (window.top === window.self && e.data === "_xx_gemius_getref_xx_" && e.origin && /^(http|https):\/\/.+\.hit\.gemius\.pl(\/?|\/.+)$/.test(e.origin)) {
